...
import NkProductCard from '../../../Vue3/src/components/ProductCard.vue'
import NkProductList from '../../../Vue3/src/components/ProductList.vue'
import NkTodoTask from '../../../Vue3/src/components/TodoTask.vue'
import NkTodoTaskList from '../../../Vue3/src/components/TodoTaskList.vue'
...
const icons: Record<string, string> = {
  ...
  refresh: '<svg viewBox="0 0 16 16"><path fill-rule="evenodd" d="M8 3a5 5 0 1 0 4.546 2.914.5.5 0 0 1 .908-.417A6 6 0 1 1 8 2v1z"/><path d="M8 4.466V.534a.25.25 0 0 1 .41-.192l2.36 1.966c.12.1.12.284 0 .384L8.41 4.658A.25.25 0 0 1 8 4.466z"/></svg>',
  clock: '<svg viewBox="0 0 16 16"><path d="M8 3.5a.5.5 0 0 1 .5.5V8a.5.5 0 0 1-.5.5H5a.5.5 0 0 1 0-1h2.5V4a.5.5 0 0 1 .5-.5z"/><path d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z"/></svg>',
  bell: '<svg viewBox="0 0 16 16"><path d="M8 16a2 2 0 0 0 2-2H6a2 2 0 0 0 2 2z"/><path d="M8 1.918l-.797.161A4.002 4.002 0 0 0 4 6c0 .628-.134 2.197-.459 3.742-.16.767-.376 1.566-.663 2.258h10.244c-.287-.692-.502-1.49-.663-2.258C12.134 8.197 12 6.628 12 6a4.002 4.002 0 0 0-3.203-3.92L8 1.917zM14.22 12c.223.447.481.801.78 1H1c.299-.199.557-.553.78-1C2.68 10.2 3 6.88 3 6c0-2.42 1.72-4.44 4.005-4.901a1 1 0 1 1 1.99 0A5.002 5.002 0 0 1 13 6c0 .88.32 4.2 1.22 6z"/></svg>',
}
...
export default {
  ...
  enhanceApp({ app }: { app: App }) {
    const componentMap: [any, string][] = [
      ...
      [NkProductCard, 'ProductCard'], [NkProductList, 'ProductList'],
      [NkTodoTask, 'TodoTask'], [NkTodoTaskList, 'TodoTaskList'],
    ]
